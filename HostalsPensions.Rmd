...
## Allotjament en Hostal i Pensions - AAI - Aj.BCN
...
crear.png.worldmap.familysize <- runParam
crear.png.worldmap.extra.familysize <- runParam
crear.svg.worldmap.familysize <- runParam
crear.svg.panzoom.worldmap.familysize <- runParam
crear.png.pt.membres.t <- runParam
crear.png.pt.regim.allotjament.t <- runParam
crear.png.pt.durada.t <- runParam
crear.png.treemap.nacionalitat <- runParam
crear.png.dt.motiu <- runParam
crear.png.leaflet.agegroups <- runParam
crear.png.dt.origens.menors <- runParam
crear.png.pt.despesa.t <- runParam
...
mostrar.ggplot.nacionalitat <- runParam
mostrar.ggplot.motiu <- runParam
...
if (crear.informe.word == TRUE) {
  ...
  my_doc <- my_doc %>% 
    body_add_par(value = paste0("Allotjament en Hostals i Pensions (", anydades, ")"), style = "Title") %>% 
...
my_file <- file.path("K:\\QUOTA\\DIMM_COMU\\SAIER\\Hostals\ i\ Pensions\\2018\\Estades\ reals", "BD_Estades_Hostals_Pensions_v04.xlsx")
...
head(my_data)
my_data2 <- my_data %>% 
    filter(grepl("ALLOTJAMENT", REGIM) | grepl("PENSIO", REGIM))
...
my_data4 <- count(my_data2, NacionalitatAngles, Mes, AdultMenor, Genere, wt = NULL, sort = FALSE)
...
# Plot Map Using rworldmap
  ...
  my_mapped_data <- joinCountryData2Map(my_data2, joinCode = "NAME", 
...
if (crear.svg.worldmap.familysize == TRUE) {
  # Plot as svg
...
if (crear.png.worldmap.familysize == TRUE) {
  # Mostra-ho en pantalla també
  # Redo as png
...
if (crear.svg.panzoom.worldmap.familysize == TRUE) {
  # =======================================================
...
if (crear.png.worldmap.extra.familysize == TRUE) {
  ...
  if (crear.informe.word == TRUE) {
    ...
    my_doc <- my_doc %>% 
      body_add_break() %>% 
      body_add_par(value = "Unitats familiars", style = "heading 1") %>% 
      body_add_par("", style = "Normal") %>% # blank paragraph
      body_add_par(value = "Mida de les unitats familiars per països", style = "heading 2") %>% 
      body_add_par("", style = "Normal") %>% # blank paragraph
...
### Taula Resum - Mitjanes

```{r Taula Resum Mida Mitjana Unitats Familiars (més d´un membre)}
if (crear.html.pt.membres.t == TRUE) {
  pt.membres.avg.t <- rpivotTable(
    data = my_data2, 
    rows = c("Nacionalitat"), 
    cols=c("Categoria"), 
    vals = "Membres", 
    ...
    exclusions = list( Membres = list( "1")),
    rendererName = "Heatmap"
  )
  frameWidget(pt.membres.avg.t)
  
  
  saveWidget(pt.membres.avg.t, file=file.path(getwd(), htmlpath, paste0(anydades, ".pt.membres.uf2.avg.t.html")), selfcontained=TRUE) 
}

if (crear.png.pt.membres.t == TRUE) {
  webshot(file.path(getwd(), htmlpath, paste0(anydades, ".pt.membres.uf2.avg.t.html")),
          file=file.path(getwd(), imgpath, paste0(anydades, ".pt.membres.uf2.avg.t.png")),
...
if (mostrar.html.pt.membres.t == TRUE) {
  ...
  if (crear.informe.word == TRUE) {
    ...
    my_doc <- my_doc %>% 
      body_add_par("", style = "Normal") %>% # blank paragraph
      body_add_par(value = "Mida Mitjana de les Unitats Familiars", style = "heading 2") %>% 
      body_add_par("", style = "Normal") %>% # blank paragraph
      body_add_img(src = file.path(getwd(), imgpath, paste0(anydades, ".pt.membres.uf2.avg.t.png")), width = 6, height = 3, style = "centered") %>% 
      body_add_par("Mitjana del número de membres de les famílies amb 2 o més membres allotjats", style = "Balloon Text") %>%
      body_add_par("", style = "Normal") %>% # blank paragraph
...
```{r Taula Resum Mida Màxima Unitats Familiars (més d´un membre)}
if (crear.html.pt.membres.t == TRUE) {
  
  pt.membres.max.t <- rpivotTable(
    data = my_data2, 
    rows = c("Nacionalitat"), 
    cols=c("Categoria"), 
    vals = "Membres", 
  ...
  frameWidget(pt.membres.max.t)
  
  
  saveWidget(pt.membres.max.t, file=file.path(getwd(), htmlpath, paste0(anydades, ".pt.membres.uf2.max.t.html")), selfcontained=TRUE) 
}

if (crear.png.pt.membres.t == TRUE) {
  webshot(file.path(getwd(), htmlpath, paste0(anydades, ".pt.membres.uf2.max.t.html")),
          file=file.path(getwd(), imgpath, paste0(anydades, ".pt.membres.uf2.max.t.png")),
          delay=0.5, selector=".pvtRendererArea") # to get only the heatmap table with results
}
...
if (mostrar.html.pt.membres.t == TRUE) {
  ...
  if (crear.informe.word == TRUE) {
    ...
    my_doc <- my_doc %>% 
      body_add_par("", style = "Normal") %>% # blank paragraph
      body_add_par(value = "Mida MAXIMA de les Unitats Familiars", style = "heading 2") %>% 
      body_add_par("", style = "Normal") %>% # blank paragraph
      body_add_img(src = file.path(getwd(), imgpath, paste0(anydades, ".pt.membres.uf2.max.t.png")), width = 6, height = 3, style = "centered") %>% 
      body_add_par("Valor màxim del número de membres de les famílies amb 2 o més membres allotjats", style = "Balloon Text") %>%
      body_add_par("", style = "Normal") %>% # blank paragraph
      body_add_par("La intensitat del color vermell és proporcional a la suma de casos de cada tipus", style = "Balloon Text")
...
if (crear.png.pt.regim.allotjament.t == TRUE) {
...
if (crear.png.dt.regim.allotjament.month == TRUE) { 
...
if (crear.html.pt.durada.t == TRUE) {
  pt.durada.t <- rpivotTable(
    ...
    height="800px",   
    #  inclusions = list( Categoria = list("NO CONSTA")),
    exclusions = list( REGIM = list( c("BUGADERIES", "COMIDA EXTRA"))),
    rendererName = "Heatmap"
  )
...
if (mostrar.html.pt.durada.t == TRUE) {
  ...
  if (crear.informe.word == TRUE) {
    ...
    my_doc <- my_doc %>% 
      body_add_break() %>% 
      body_add_par("", style = "Normal") %>% # blank paragraph
      body_add_par(value = "Durades", style = "heading 2") %>% 
      body_add_par("", style = "Normal") %>% # blank paragraph
      body_add_img(src = file.path(getwd(), imgpath, paste0(anydades, ".pt.DURADA.t.png")), width = 3, height = 3, style = "centered") %>% 
      body_add_par(" Pernoctacions de persones allotjades, en qualsevol regim d'allotjament") %>%
      body_add_par("", style = "Normal") %>% # blank paragraph
      body_add_par("La intensitat del color vermell és proporcional a la suma de casos de cada tipus", style = "Balloon Text")
...
if (mostrar.ggplot.nacionalitat == TRUE) {
  # Mostra-ho en pantalla també
  ggplot.nacionalitat
}
...
if (crear.png.treemap.nacionalitat == TRUE) {
  # basic treemaps
...
if (crear.informe.word == TRUE) {
  ...
  # Afegir contingut a l'informe en Word
  my_doc <- my_doc %>% 
    body_add_par(value = "Motius de l'allotjament (gràfic)", style = "heading 2") %>% 
    body_add_par("", style = "Normal") %>% # blank paragraph
 ...
 if (crear.png.dt.motiu == TRUE) {
  ...
  if (crear.informe.word == TRUE) {
    ...
    my_doc <- my_doc %>% 
      body_add_break() %>% 
      body_add_par("", style = "Normal") %>% # blank paragraph
      body_add_par(value = "Motius de l'allotjament (taula)", style = "heading 2") %>% 
      body_add_par("", style = "Normal") %>% # blank paragraph
...
```{r Age group of users}
  ...
  # -------------------------------------------------------------
  my_data6 <- count(my_data2, NacionalitatAngles, AdultMenor, wt = NULL, sort = FALSE)
  ...
  if (crear.png.leaflet.agegroups == TRUE) {
...
if (crear.informe.word == TRUE) {
  ...
  my_doc <- my_doc %>% 
    body_add_break() %>% 
    body_add_par(value = "Orígens dels menors (mapa)", style = "heading 2") %>% 
    body_add_par("", style = "Normal") %>% # blank paragraph
...
```{r Idem dels Orígens dels menors en taula}
...
if (crear.png.dt.origens.menors == TRUE) {
 # Make screenshot out of that heatmap-like table, just in case, for easy adding into word document report
  ...
  if (crear.informe.word == TRUE) {
    ...
    my_doc <- my_doc %>% 
      body_add_break() %>% 
      body_add_par("", style = "Normal") %>% # blank paragraph
      body_add_par(value = "Orígens dels menors (taula)", style = "heading 2") %>% 
      body_add_par("", style = "Normal") %>% # blank paragraph
...
#  filter(grepl("2018", MesIniciAllotjament)) %>%
  count(MesIniciAllotjament,
        Categoria,
        wt = NULL,
        sort = FALSE)
...
if (crear.informe.word == TRUE) {
  ...
  my_doc <- my_doc %>% 
    body_add_break() %>% 
    body_add_par(value = "Entrades i Sortides", style = "heading 1") %>% 
    body_add_par("", style = "Normal") %>% # blank paragraph
    body_add_par(value = "Entrades mensuals", style = "heading 2") %>% 
    body_add_par("", style = "Normal") %>% # blank paragraph
...
if (crear.informe.word == TRUE) {
  ...
  my_doc <- my_doc %>% 
    body_add_par("", style = "Normal") %>% # blank paragraph
    body_add_par(value = "Sortides Mensuals", style = "heading 2") %>% 
    body_add_par("", style = "Normal") %>% # blank paragraph
...
if (crear.informe.word == TRUE) {
  ...
  my_doc <- my_doc %>% 
    body_add_break() %>% 
    body_add_par(value = "Previsió de Sortida", style = "heading 2") %>% 
    body_add_par("", style = "Normal") %>% # blank paragraph
...
if (crear.informe.word == TRUE) {
  ...
  my_doc <- my_doc %>% 
    body_add_par("", style = "Normal") %>% # blank paragraph
    body_add_par(value = "Situació de Refugiats Fora de Programa Estatal", style = "heading 1") %>% 
    body_add_par("", style = "Normal") %>% # blank paragraph
...
if (crear.png.pt.despesa.t == TRUE) {
...
if (mostrar.html.pt.despesa.t == TRUE) {
  ...
  if (crear.informe.word == TRUE) {
    ...
    my_doc <- my_doc %>% 
      body_add_break() %>% 
      body_add_par("", style = "Normal") %>% # blank paragraph
      body_add_par(value = "Evolució de la despesa per categoria d'usuaris", style = "heading 1") %>% 
      body_add_par("", style = "Normal") %>% # blank paragraph
      body_add_img(src = file.path(getwd(), imgpath, paste0(anydades, ".pt.despesa.t.png")), width = 6, height = 5, style = "centered") %>% 
      body_add_par("La intensitat del color vermell és proporcional a la suma de casos de cada tipus", style = "Balloon Text")
