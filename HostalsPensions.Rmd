...
crear.html.pt.SA.t <- runParam
crear.html.dt.sa.month <- runParam
crear.html.sankey.sa.plot <- runParam
...
if (crear.informe.word == TRUE) {
  ...
  my_doc <- read_docx(path=file.path(getwd(), templatepath, paste0(anydades, ".Word_AAI_template_v03.docx")) )
  #my_doc <- read_docx()
  # styles_info(my_doc)
  
  my_doc <- my_doc %>% 
    body_add_par(value = paste0("Derivacions del CUESB al SAIER (", anydades, ")"), style = "Title") %>% 
...
# Get the data selected
    ...
    # print(my_doc2, target=file.path(getwd(), docpath, paste0(anydades, ".MSCharts.docx")))
...
#                         file.path(getwd(), htmlpath, paste0(anydades, ".plotly.nacionalitat.barchart.html"))
# )
...
# 
# ggsave(paste0(anydades, ".barchart.nacionality.faceted.png"),
...
#   body_add_par("", style = "Normal") %>% # blank paragraph
#   body_add_img(src = file.path(getwd(), imgpath, paste0(anydades, ".barchart.nacionality.faceted.png")), width = 6, height = 3, style = "centered") %>% 
#   body_add_par("", style = "Normal") # blank paragraph
# 
# 
# # Mostra-ho en pantalla també
...
if (crear.html.ggplotly.nacionalitat == TRUE) {
  htmlwidgets::saveWidget(ggplotly.2017.nacionalitat, file=file.path(getwd(), htmlpath, paste0(anydades, ".ggplotly.nacionalitat.html")), selfcontained=TRUE) 
}
...
if (crear.html.pnacio.i == TRUE) {
  saveWidget(p2017.nacio.i, file=file.path(getwd(), htmlpath, paste0(anydades, ".d2tree2.nacionalitat.html")), selfcontained=TRUE) 
}

if (mostrar.pnacio.i == TRUE) {
  p2017.nacio.i
}
...
if (crear.informe.word == TRUE) {
  ...
  my_doc <- my_doc %>% 
    ...
    body_add_par("", style = "Normal") %>% # blank paragraph
    #  body_add_img(src = file.path(getwd(), imgpath, paste0(anydades, ".barchart.n.mes.png")), width = 6, height = 3, style = "centered") %>% 
    #  body_add_par("", style = "Normal") %>% # blank paragraph
...
```{r Age group of users}
  ...
  leaflet.2017.agegroups <- basemap %>%
    ...
    if (crear.html.leaflet.agegroups == TRUE) {
      saveWidget(leaflet.2017.agegroups, file=file.path(getwd(), htmlpath, paste0(anydades, ".leaflet.agegroups.html")), selfcontained=TRUE) 
    }
...
#    opacity = 1
  ...
  if (crear.html.leaflet.gender == TRUE) {
    saveWidget(leaflet.2017.gender, file=file.path(getwd(), htmlpath, paste0(anydades, ".leaflet.gender.html")), selfcontained=TRUE) 
  }
...
```{r Gràfic de barres de Situacions Administratives, echo=TRUE}
...
```{r Denegats a un altre País Europeu, echo=TRUE}
...
if (crear.png.ggplot.pais.tramit.ue == TRUE) {
  ggsave(paste0(anydades, ".barchart.pais.tramit.ue.png"),
...
if (mostrar.png.ggplot.pais.tramit.ue == TRUE) {
  # Mostra-ho en pantalla també
...
if (crear.informe.word == TRUE) {
  ...
  my_doc <- my_doc %>% 
    ...
    #   body_add_img(src = file.path(getwd(), imgpath, paste0(anydades, ".barchart.pais.tramit.ue.png")), width = 6, height = 4, style = "centered") %>% 
...
```{r Gràfic de barres de Perfils, echo=TRUE}
...
if (crear.png.ggplot.perfils == TRUE) {
  ggsave(paste0(anydades, ".barchart.perfils.png"),
...
if (mostrar.ggplot.perfils == TRUE) {
  # Mostra-ho en pantalla també
  ggplot.2017.perfils
}
...
if (crear.informe.word == TRUE) {
  ...
  my_doc <- my_doc %>% 
    body_add_par("", style = "Normal") %>% # blank paragraph
    #  body_add_img(src = file.path(getwd(), imgpath, paste0(anydades, ".barchart.perfils.png")), width = 6, height = 3, style = "centered")  
...
if (crear.png.ggplot.dec.majoria.edat == TRUE) {
  ggsave(paste0(anydades, ".barchart.dec.majoria.edat.png"),
...
if (mostrar.ggplot.dec.majoria.edat == TRUE) {
  # Mostra-ho en pantalla també
...
if (crear.informe.word == TRUE) {
  ...
  my_doc <- my_doc %>% 
    body_add_par("", style = "Normal") %>% # blank paragraph
    #  body_add_img(src = file.path(getwd(), imgpath, paste0(anydades, ".barchart.dec.majoria.edat.png")), width = 6, height = 3, style = "centered")
...
if (crear.html.sankey.sa.plot == TRUE) {
  saveWidget(sankey.2017.sa.plot, file=file.path(getwd(), htmlpath, paste0(anydades, ".sankey.sa.p.html")), selfcontained=TRUE) 
}
webshot(file.path(getwd(), htmlpath, paste0(anydades, ".sankey.sa.p.html")),
        file=file.path(getwd(), imgpath, paste0(anydades, ".sankey.sa.p.png")),
        delay=0.5, selector="#htmlwidget_container")

if (mostrar.html.sankey.sa.plot == TRUE) {
  sankey.2017.sa.plot
}
...
if (crear.informe.word == TRUE) {
  ...
  my_doc <- my_doc %>% 
    ...
    body_add_par("", style = "Normal") %>% # blank paragraph
    body_add_img(src = file.path(getwd(), imgpath, paste0(anydades, ".sankey.sa.p.png")), width = 6, height = 4, style = "centered") %>% 
    body_add_par("", style = "Normal") %>% # blank paragraph
...
if (crear.png.ggplot.n.mes.saier == TRUE) {
  ggsave(paste0(anydades, ".barchart.n.mes.saier.png"),
...
if (mostrar.ggplot.n.mes.saier == TRUE) {
  # Mostra-ho en pantalla també
...
if (crear.informe.word == TRUE) {
  ...
  my_doc <- my_doc %>% 
    ...
    body_add_par(value = "Evolució mensual", style = "heading 2") %>% 
    body_add_par("", style = "Normal") %>% # blank paragraph
    #  body_add_img(src = file.path(getwd(), imgpath, paste0(anydades, ".barchart.n.mes.saier.png")), width = 6, height = 3, style = "centered") %>% 
...
if (crear.informe.word == TRUE) {
  ...
  print(my_doc, target=file.path(getwd(),
                                 docpath,
                                 paste0(paste0(anydades, ".Derivacions_CUESB_a_SAIER_v"), 
                                        format(Sys.Date(), 
                                               format="%y%m%d"
                                        ),
                                        ".docx")
